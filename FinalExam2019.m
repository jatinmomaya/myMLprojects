...
mydata = imageDatastore('faces',...
    'includeSubfolders',true,...
    'LabelSource','foldernames');
[mydataTrain, mydataValidation] =...
    splitEachLabel(mydata,0.7);

mydataResizedTrain = augmentedImageDatastore([227 227], mydataTrain,'colorpreprocessing','gray2rgb');
mydataResizedValidation = augmentedImageDatastore([227 227], mydataValidation,'colorpreprocessing','gray2rgb');
...
net = trainNetwork(mydataResizedTrain,lgraph_2,options);
